...
(function () {
    ...
    module.exports = function (spec) {
        ...
        const startsWith = function (interval) {
            return comp.eq(lo, interval.lo);
        };

        const endsWith = function (interval) {
            return comp.eq(hi, interval.hi);
        };

        return Object.freeze({lo, hi, overlaps, equalsInterval, compare, takesPlaceAfter, toString, startsBefore, endsAfter, comparator: comp, meets, startsWith, endsWith});
    };
}());
