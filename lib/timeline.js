...
(function () {
    ...
    module.exports = function (spec) {
        ...
        const insertOne = function (anInterval) {
            ...
            const insertionStartIndex = (function () {
            ...
            const overlapCount = (function () {
                const intervalToBeInserted = intervaler(anInterval);
                let i = insertionStartIndex;

                while (i < intervals.length && !intervaler(intervals[i]).takesPlaceAfter(intervalToBeInserted)) {
                    i += 1;
                }

                return i - insertionStartIndex;
            }());
        ...
        const removeOne = function (anInterval) {
            const removalStartIndex = (function () {
                const intervalToBeRemoved = intervaler(anInterval);
                let i = 0;

                while (i < intervals.length && intervalToBeRemoved.takesPlaceAfter(intervaler(intervals[i]))) {
                    i += 1;
                }
